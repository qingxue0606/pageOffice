...
public class TestExcelController {
    ...
    @RequestMapping(value = "/xiang/excel2", method = RequestMethod.GET)
    public ModelAndView showExcel2(HttpSession session, HttpServletRequest request, Map<String, Object> map) {
        ...
        map.put("pageoffice", poCtrl.getHtmlCode("PageOfficeCtrl1"));
        //--- PageOffice的调用代码 结束 -----
        ModelAndView mv = new ModelAndView("xiang/Excel2");
        return mv;
